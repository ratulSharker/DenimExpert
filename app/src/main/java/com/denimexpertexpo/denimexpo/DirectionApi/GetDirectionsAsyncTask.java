...
public class GetDirectionsAsyncTask extends AsyncTask<Map<String, String>, Object, ArrayList<LatLng>> {
    ...
    public GetDirectionsAsyncTask(DirectionListener listener) {
        super();
    ...
    public void onPostExecute(ArrayList result) {
        ...
        if (exception == null) {
            ...
            if (this.directionListener != null)
                this.directionListener.onDirectionRecieved(result);
        } else {
            //processException();
            if (this.directionListener != null)
                this.directionListener.onDirectionException(exception);
